...
- [Prerequisites](#prerequisites)
  - [For Image Consumers](#for-image-consumers)
...
- [Environment Setup](#environment-setup)
  ...
  - [Initialize the BlueBuild Modules Subtree](#initialize-the-bluebuild-modules-subtree)
    ...
    - [Adding Additional Modules from the Same Remote](#adding-additional-modules-from-the-same-remote)
  - [Repository Configuration](#repository-configuration)
  - [Required Secrets (GitHub)](#required-secrets-github)
...
- [Recipe Development](#recipe-development)
  ...
  - [Flatpak Management](#flatpak-management)
  - [Dotfile Management (chezmoi)](#dotfile-management-chezmoi)
  - [GNOME Extensions](#gnome-extensions)
- [Custom Modules](#custom-modules)
- [Testing](#testing)
  - [CI-Based Testing (GitHub Actions)](#ci-based-testing-github-actions)
  - [Local Build & Test (bluebuild CLI)](#local-build--test-bluebuild-cli)
    - [Prerequisites](#prerequisites-1)
    - [Step-by-Step: Build Locally](#step-by-step-build-locally)
    - [Step-by-Step: Deploy to the Test VM](#step-by-step-deploy-to-the-test-vm)
    - [Strategy C: Push to Existing LAN Registry](#strategy-c-push-to-existing-lan-registry)
    - [Strategy A: Tarball Transfer via SSH](#strategy-a-tarball-transfer-via-ssh)
    - [Strategy B: Manual Podman Pull + Rebase](#strategy-b-manual-podman-pull--rebase)
    - [Troubleshooting Network & Daemon Issues](#troubleshooting-network--daemon-issues)
  - [Signature Verification](#signature-verification)
- [Common Tasks](#common-tasks)
  - [Update Base Image Version](#update-base-image-version)
  - [Add a New Recipe to the Build Matrix](#add-a-new-recipe-to-the-build-matrix)
  - [Change Build Schedule](#change-build-schedule)
