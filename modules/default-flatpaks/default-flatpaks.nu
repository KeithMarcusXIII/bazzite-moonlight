...
def main [configStr: string] {
    ...
    if ('user' in $config or 'system' in $config) {
        ...
        print $"It seems like you are trying to run the new (ansi default_italic)default-flatpaks@v3(ansi reset) module with configuration made for the older version."
